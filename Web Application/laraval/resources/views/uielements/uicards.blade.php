...
<div class="container-fluid">
         <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3">
               <div class="card">
                  <img src="{{asset('images/page-img/07.jpg')}}" class="card-img-top" alt="#">
                  <div class="card-body">
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6 text-end">
               <div class="card">
                  <div class="card-body d-grid gap-2">
                     <h4 class="card-title">Special title treatment</h4>
                     <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-4 col-sm-6">
               <div class="card bg-dark text-white">
                  <img src="{{asset('images/page-img/07.jpg')}}" class="card-img" alt="#">
         ...
         <div class="row">
            <div class="col-sm-12">
               <h3 class="mb-3">Horizontal Card</h3>
            </div>
            <div class="col-md-6 col-lg-6">
               <div class="card mb-2">
                  <div class="row no-gutters">
                     <div class="col-md-6 col-lg-4">
                        <img src="{{asset('images/page-img/08.jpg')}}" class="card-img" alt="#">
                     </div>
            ...
            <div class="col-md-6 col-lg-6">
               <div class="card">
                  <div class="row no-gutters flex-row-reverse">
                     <div class="col-md-6 col-lg-4">
                        <img src="{{asset('images/page-img/09.jpg')}}" class="card-img" alt="#">
                     </div>
                     <div class="col-md-6 col-lg-8">
         ...
         <div class="row">
            <div class="col-sm-12">
               <h3 class="mb-2">Card Colored Styles</h3>
            </div>
