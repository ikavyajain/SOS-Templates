...
<ul class="navbar-nav iq-main-menu">
    <li class="nav-item static-item">
     ...
     <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="home" data-bs-parent="#sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('restaurantdashboard')}}" href="{{route('restaurantdashboard')}}">
                   <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute('specialpages/dishdetail')}}" href="{{route('specialpages.dishdetail')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('specialpages/addtocart')}}" href="{{route('specialpages.addtocart')}}">
                   <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('specialpages/orderhistory')}}" href="{{route('specialpages.orderhistory')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('specialpages/orderdetail')}}" href="{{route('specialpages.orderdetail')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('specialpages/menu')}}" href="{{route('specialpages.menu')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
             ...
             <li class="nav-item">
                <a class="nav-link {{activeRoute('specialpages/customerreview')}}" href="{{route('specialpages.customerreview')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('specialpages/restaurantdetail')}}" href="{{route('specialpages.restaurantdetail')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute('app/userprofile')}}" href="{{route('app.userprofile')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('app/useradd')}}" href="{{route('app.useradd')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('app/userlist')}}" href="{{route('app.userlist')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute('errors/error404')}}" href="{{route('errors.error404')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('errors.error500')}}" href="{{route('errors.error500')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('errors/maintenance')}}" href="{{route('errors.maintenance')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item static-item">
     ...
     <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="ui"  data-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uiavatars')}}" href="{{route('uielements.uiavatars')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uialerts')}}" href="{{route('uielements.uialerts')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uibadges')}}" href="{{route('uielements.uibadges')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uibreadcrumb')}}" href="{{route('uielements.uibreadcrumb')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uibuttons')}}" href="{{route('uielements.uibuttons')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uibuttonsgroup')}}" href="{{route('uielements.uibuttonsgroup')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uiboxshadow')}}" href="{{route('uielements.uiboxshadow')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uicolor')}}" href="{{route('uielements.uicolor')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uicards')}}" href="{{route('uielements.uicards')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uicarousel')}}" href="{{route('uielements.uicarousel')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uigrid')}}" href="{{route('uielements.uigrid')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uihelperclasses')}}" href="{{route('uielements.uihelperclasses')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uiimages')}}" href="{{route('uielements.uiimages')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements.uilistgroup')}}" href="{{route('uielements.uilistgroup')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uimodal')}}" href="{{route('uielements.uimodal')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uinotifications')}}" href="{{route('uielements.uinotifications')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uipagination')}}" href="{{route('uielements.uipagination')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements.uipopovers')}}" href="{{route('uielements.uipopovers')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements.uitypography')}}" href="{{route('uielements.uitypography')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uitabs')}}" href="{{route('uielements.uitabs')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uitooltips')}}" href="{{route('uielements.uitooltips')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('uielements/uiembedvideo')}}" href="{{route('uielements.uiembedvideo')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute('form/formelement')}}" href="{{route('form.formelement')}}">
                   <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('form/formwizard')}}" href="{{route('form.formwizard')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('form/formvalidation')}}" href="{{route('form.formvalidation')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('table/tabledata')}}" href="{{route('table.tabledata')}}">
                   <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
