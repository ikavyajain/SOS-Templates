...
<div class="row">
    ...
    <div class="col-lg-4 mt-5">
        <div class="card dish-card profile-img3"
        data-iq-gsap="onStart"
                     data-iq-opacity="0"
                     data-iq-position-y="-40"
                     data-iq-duration=".6"
            ...
            <div class="card-body">
                <div class="text-center ">
                    <div class="profile-img40 ">
                        <img src="{{asset('images/restaurant/01.png')}}" class="img-fluid rounded-pill w-50" alt="profile-image">
                    </div>
        ...
        data-iq-gsap="onStart"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between pb-3 ">
                    ...
                    <img src="{{asset('images/restaurant/02.png')}}" class="img-fluid rounded avatar-160" alt="profile-image">
                </div>
        ...
        data-iq-ease="none">
            <div class="card-body">
                <div class="d-flex justify-content-between pb-3 ">
                    ...
                    <img src="{{asset('images/restaurant/03.png')}}" class="img-fluid rounded avatar-160" alt="profile-image">
                </div>
                <div class="iq-share-btn">
                    <button type="button" class="btn btn-primary rounded-pill mt-3 me-2">
                    <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="20px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="card-body py-0">
                <ul class="list-inline list-main iq-special-product">
                    <li class="py-3 d-flex align-items-center ">
                        <img src="{{asset('images/restaurant/04.png')}}" class="img-fluid rounded-circle avatar-45" alt="profile-image">
                        <div class="ms-3">
                    ...
                    <li class="py-3 d-flex align-items-center">
                     <img src="{{asset('images/restaurant/05.png')}}" class="img-fluid rounded-circle avatar-45" alt="profile-image">
                    <div class="ms-3">
                    ...
                    <li class="py-3 d-flex align-items-center">
                     <img src="{{asset('images/restaurant/06.png')}}" class="img-fluid rounded-circle avatar-45" alt="profile-image">
                    <div class="ms-3">
                    ...
                    <li class="py-3 d-flex align-items-center">
                     <img src="{{asset('images/restaurant/07.png')}}" class="img-fluid rounded-circle avatar-45" alt="profile-image">
                    <div class="ms-3">
    ...
    <div class="col-lg-4">
        ...
        data-iq-ease="none">
            ...
            <div class="card-body">
                <div class="iq-other-branch">
                    <div class="iq-branch pb-3">
                        <div class="d-flex align-items-center mb-2">
                            <img src="{{asset('images/restaurant/09.png')}}" class="img-fluid rounded-circle avatar-40 me-2" alt="">
                        ...
                        <div class="media-support-body">
                            <p class="mb-0">           
                                </p><p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type.</p><p></p>
                ...
                <div class="mt-3">
                    <div class="d-flex align-items-center mb-2">
                    <img src="{{asset('images/restaurant/10.png')}}" class="img-fluid rounded-circle avatar-40 me-2" alt="">
                    <div class="media-support-info">
