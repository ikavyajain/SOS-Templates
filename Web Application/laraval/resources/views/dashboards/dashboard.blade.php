...
<div class="row">
   <div class="col-md-12 col-lg-8">
      ...
      data-iq-ease="none">
         <div class="hero-image p-3" style="background: url('{{asset('images/layouts/01.png')}}') no-repeat center right;background-size: cover;background-position: center;">
               ...
               <div class="swiper-wrapper">
                     ...
                     data-iq-ease="none">
                        <div class="card-body">
                           <div class="text-center">
                              <img src="{{asset('images/layouts/1.png')}}" alt="header" class="img-fluid rounded-pill mb-3">
                     ...
                     data-iq-ease="none">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="{{asset('images/layouts/2.png')}}" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     data-iq-ease="none">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="{{asset('images/layouts/3.png')}}" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     data-iq-ease="none">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="{{asset('images/layouts/4.png')}}" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     data-iq-ease="none">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="{{asset('images/layouts/5.png')}}" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     data-iq-ease="none">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="{{asset('images/layouts/6.png')}}" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     data-iq-ease="none">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="{{asset('images/layouts/7.png')}}" alt="header" class="img-fluid rounded-pill mb-3">
            ...
            <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
               <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 row-cols-xxl-4">
                  ...
                  data-iq-gsap="onStart"
                     ...
                     data-iq-trigger="scroll"
                     data-iq-ease="none">
                     <x-categorymenu  categoryImage="16.png" categoryTitle="Mushroom" rating="3" oldPrice="$7.49" categoryPrice="$8.49"/>
                  ...
                  data-iq-gsap="onStart"
                     ...
                     data-iq-trigger="scroll"
                     data-iq-ease="none">
                     <x-categorymenu rakesh="1more"  categoryImage="15.png" categoryTitle="Spaghetti" rating="3" oldPrice="$7.29"/>
                  </div>
                  <div class="col"
                  data-iq-gsap="onStart"
                     data-iq-opacity="0"
                     ...
                     data-iq-trigger="scroll"
                     data-iq-ease="none">
                     <x-categorymenu categoryImage="14.png" categoryTitle="Vegetable" rating="3"  oldPrice="$5.49"/>
                  </div>
                  <div class="col" 
                  data-iq-gsap="onStart"
                     data-iq-opacity="0"
                     ...
                     data-iq-delay=".9"
                     data-iq-trigger="scroll">
                     <x-categorymenu categoryImage="12.png" categoryTitle="Sweets" rating="3" oldPrice="$6.49"/>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="swiper swiper-container d-slider3">
               <div class="swiper-wrapper">
                  ...
                  data-iq-gsap="onStart"
                     ...
                     data-iq-trigger="scroll"
                     data-iq-ease="none">
                     <x-trendingorders trendingDay="yes" trendingImage="17.png" trendingDay="Top of the week" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49"/>
                  <x-trendingorders trendingImage="19.png" trendingDay="Top of the week" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49"/>                     
                  </div>
                  <div class="swiper-slide"
                  data-iq-gsap="onStart"
                     data-iq-opacity="0"
                     ...
                     data-iq-trigger="scroll"
                     data-iq-ease="none">
                     <x-trendingorders trendingImage="14.png" trendingDay="Top of the day" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49"/>
                  <x-trendingorders trendingImage="20.png" trendingDay="Top of the month" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49"/>                     
                  </div>
                  <div class="swiper-slide" 
                  data-iq-gsap="onStart"
                     data-iq-opacity="0"
                     ...
                     data-iq-trigger="scroll"
                     data-iq-ease="none">
                     <x-trendingorders trendingImage="18.png" trendingDay="Top of the month" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49"/>
                  <x-trendingorders trendingImage="21.png" trendingDay="Top of the day" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49"/>
                  </div>  
                  <div class="swiper-slide"
                  data-iq-gsap="onStart"
                     data-iq-opacity="0"
               ...
               <div class="card-body">
                  <div class="text-center profile-img51">
                     <div class="profile-img41 ">
                        <img src="{{asset('images/layouts/8.png')}}" class="img-fluid rounded-pill " alt="profile-image">
                     </div>
               ...
               <div class="card-body">
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4">
                        <div class="profile-img11">
                           <img src="{{asset('images/layouts/13.png')}}" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="{{asset('images/layouts/13.png')}}" class="img-fluid rounded-pill avatar-115"  alt="img"
                           data-iq-gsap="onStart"
                           data-iq-opacity="0"
                           data-iq-scale=".6"
                           data-iq-rotate="180"
                  ...
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                        <div class="profile-img11">
                           <img src="{{asset('images/layouts/12.png')}}" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="{{asset('images/layouts/12.png')}}" class="img-fluid rounded-pill avatar-115"  alt="img"
                           data-iq-gsap="onStart"
                           data-iq-opacity="0"
                           data-iq-scale=".6"
                           data-iq-rotate="180"
                  ...
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                        <div class="profile-img11">
                           <img src="{{asset('images/layouts/11.png')}}" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="{{asset('images/layouts/11.png')}}" class="img-fluid rounded-pill avatar-115"  alt="img"
                            data-iq-gsap="onStart"
                           data-iq-opacity="0"
                           data-iq-scale=".6"
                           data-iq-rotate="180"
                        ...
                        <div class="me-4 text-end">
                           <span class="mb-1">
                              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path opacity="0.4" d="M19.6449 9.48924C19.6449 9.55724 19.112 16.298 18.8076 19.1349C18.6169 20.8758 17.4946 21.9318 15.8111 21.9618C14.5176 21.9908 13.2514 22.0008 12.0055 22.0008C10.6829 22.0008 9.38936 21.9908 8.1338 21.9618C6.50672 21.9228 5.38342 20.8458 5.20253 19.1349C4.88936 16.288 4.36613 9.55724 4.35641 9.48924C4.34668 9.28425 4.41281 9.08925 4.54703 8.93126C4.67929 8.78526 4.86991 8.69727 5.07026 8.69727H18.9408C19.1402 8.69727 19.3211 8.78526 19.464 8.93126C19.5973 9.08925 19.6644 9.28425 19.6449 9.48924" fill="#E60A0A"/>
                              <path d="M21 5.97686C21 5.56588 2rating0.6761 5.24389 20.2871 5.24389H17.3714C16.7781 5.24389 16.2627 4.8219 16.1304 4.22692L15.967 3.49795C15.7385 2.61698 14.9498 2 14.0647 2H9.93624C9.0415 2 8.26054 2.61698 8.02323 3.54595L7.87054 4.22792C7.7373 4.8219 7.22185 5.24389 6.62957 5.24389H3.71385C3.32386 5.24389 3 5.56588 3 5.97686V6.35685C3 6.75783 3.32386 7.08982 3.71385 7.08982H20.2871C20.6761 7.08982 21 6.75783 21 6.35685V5.97686Z" fill="#E60A0A"/>
                              </svg>
                           </span>
                           <p class="mb-0 text-dark">$7.49</p>
                        </div>`
                  ...
                  <div class="text-center mt-5">
                     <a type="button" href="#" class="btn btn-primary rounded-pill">Checkout</a>
                  </div>   
               </div>
            </div>
         </div>
         <div class="col-md-12 col-lg-12">
            ...
            data-iq-gsap="onStart"
             ...
             <div class="position-relative">
                  <img src="{{asset('images/layouts/40.png')}}" alt="img-1" class="img-fluid img-user">
               </div>
         </div>
      </div>
   </div>
