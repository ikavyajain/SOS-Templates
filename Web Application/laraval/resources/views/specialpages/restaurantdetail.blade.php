                ...
                <div class="card-body ">
                    <div class="d-flex profile-img41">
                        <div class="profile-img42">
                            <img src="{{asset('images/layouts/32.png')}}" class="img-fluid rounded-pill avatar-130" alt="profile-image">
                        </div>
                        <div class="d-flex align-items-center mb-4 mb-md-0">
                            <img src="{{asset('images/layouts/37.png')}}" class="img-fluid avatar-rounded avatar-60" alt="profile-image">
            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="d-grid gap-card grid-cols-2 ">
                        <img src="{{asset('images/layouts/29.png')}}" alt="post-image" class="img-fluid rounded-1" >
                        <img src="{{asset('images/layouts/30.png')}}" alt="post-image" class="img-fluid rounded-1" >
                    </div>
                    <img src="{{asset('images/layouts/31.png')}}" alt="post-image" class="img-fluid mt-4 rounded-1" >
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="swiper swiper-container d-slider4 dish-card-horizontal ">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <x-categorymenu categoryImage="33.png" categoryTitle="Cheese pizza" oldPrice="$7.49" categoryPrice="$8.49" rating=""/>
                        </div>
                        <div class="swiper-slide">
                            <x-categorymenu categoryImage="23.png" categoryTitle="pizza" oldPrice="$7.49" categoryPrice="$8.49" rating=""/>
                        </div>
                        <div class="swiper-slide">
                            <x-categorymenu categoryImage="35.png" categoryTitle="Onion pizza" oldPrice="$7.49" categoryPrice="$8.49" rating=""/>
                        </div>
                        <div class="swiper-slide">
                            <x-categorymenu categoryImage="36.png" categoryTitle="Veggie pizza" oldPrice="$7.49" categoryPrice="$8.49" rating=""/>
                        </div>
                        <div class="swiper-slide">
                            <x-categorymenu categoryImage="28.png" categoryTitle="Pasta pizza" oldPrice="$7.49" categoryPrice="$8.49" rating=""/>
                        </div>
                        <div class="swiper-slide">
                            <x-categorymenu categoryImage="25.png" categoryTitle="Spaghetti" oldPrice="$7.49" categoryPrice="$8.49" rating=""/>
                        </div>
                        <div class="swiper-slide">
                            <x-categorymenu categoryImage="26.png" categoryTitle="Vegetable" oldPrice="$7.49" categoryPrice="$8.49" rating=""/>
                        </div>
                        <div class="swiper-slide">
                            <x-categorymenu categoryImage="27.png" categoryTitle="Sweets" oldPrice="$7.49" categoryPrice="$8.49" rating=""/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body py-3">
                <div class="card rounded-1 mb-3 cusomer-card active">
                    <div class="card-body px-2 py-2">
                        <div class="d-flex">
                            <img src="{{asset('images/menu/1.png')}}" class="img-fluid avatar-rounded avatar-40" alt="profile-image">
                ...
                <div class="card rounded-1 mb-3 cusomer-card ">
                    <div class="card-body px-2 py-2">
                        <div class="d-flex">
                            <img src="{{asset('images/menu/2.png')}}" class="img-fluid avatar-rounded avatar-40" alt="profile-image">
                            <div class="ms-2 w-100">
                                <div class="d-flex justify-content-between ">
                ...
                <div class="card rounded-1 cusomer-card mb-0">
                    <div class="card-body px-2 py-2">
                        <div class="d-flex">
                            <img src="{{asset('images/menu/3.png')}}" class="img-fluid avatar-rounded avatar-40" alt="profile-image">
                            <div class="ms-2 w-100">
                                <div class="d-flex justify-content-between ">
