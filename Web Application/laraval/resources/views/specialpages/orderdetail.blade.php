        ...
        <div class="card ">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <img src="{{asset('images/order-details/2.png')}}" class="img-fluid avatar-rounded avatar-100 mt-5" alt="profile-image">
                    <h6 class="mt-3 heading-title fw-bolder"> Robert Fox</h6>
                </div>
                <div class="d-flex mt-4">
                    <svg width="19" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <table class="table table-borderless product-table rounded">
                ...
                <tbody>
                    <tr class="cart_item border-bottom">
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="{{asset('images/order-details/5.png')}}" class="img-fluid avatar-rounded avatar-70" alt="profile-image">
                                <div class="d-flex ms-4">
                                    <div>
                                        <h6 class="heading-title text-primary">Main Course</h6>
                                        <p class="mb-0 fw-bolder">Panner curry special with<br>
                                         cucumber<p>
                    ...
                    <tr class="cart_item border-bottom">
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="{{asset('images/order-details/3.png')}}" class="img-fluid avatar-rounded avatar-70" alt="profile-image">
                                <div class="d-flex ms-4">
                                    <div>
                    ...
                    <tr class="cart_item">
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="{{asset('images/order-details/4.png')}}" class="img-fluid avatar-rounded avatar-50" alt="profile-image">
                                <div class="d-flex ms-4">
                                    <div>
                                        <h6 class=" heading-title text-primary">Main Course</h6>
