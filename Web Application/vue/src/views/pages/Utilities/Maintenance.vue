<template>
    <div class="container-fluid p-0">
        <div class="iq-maintenance text-center">
            <div>
                <img src="~@/assets/images/auth/02.png" class="rounded-circle nine-img" alt="images">
                <img src="~@/assets/images/auth/01.png" class="rounded-circle ten-img" alt="images">
                <img src="~@/assets/images/auth/06.png" class="rounded-circle eleven-img" alt="images">
                <img src="~@/assets/images/auth/05.png" class="rounded-circle twelve-img" alt="images">
                <img src="~@/assets/images/auth/03.png" class="rounded-circle thirteen-img" alt="images">
                <img src="~@/assets/images/auth/04.png" class="rounded-circle fifteen-img" alt="images">
            </div>
            <div class="user-img1">
                ...
                <div class="" style="background: transparent; height: 320px;">
                    <div class="">
                        <div class="bottom-text general-zindex">
                            <h1 class="mb-2">Hang on! We are under maintenance</h1>
                            ...
                            <div class="w-50 mx-auto mt-2">
                                <div class="form-group input-group search-input">
                                    <input type="text" class="form-control maintain" placeholder="Enter your mail">
                                    <a href="#" class="btn btn-primary rounded-pill ms-2">Notify Me</a>
                                </div>
                            </div>
                        </div>
...
<script>
const coundown = () => import('@/plugins/countdown/countdown.js')
export default {
  name: 'Maintenance',
  mounted () {
    coundown()
