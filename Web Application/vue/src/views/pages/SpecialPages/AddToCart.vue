 ...
 <div class="row">
   <div class="col-md-12 col-lg-8">
      ...
      <div class="card-transparent mb-5">
         ...
         <div class="card-body">
            <Swipernew :options="newoptions" className="d-slider2">
                  <SwiperSlide>
            ...
            <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
               <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 row-cols-xxl-4">
                  <div class="col active">
                     <!-- {{> partials/components/category-menu categoryImage="16.png" categoryTitle="Mushroom" rating="3" oldPrice="$7.49" categoryPrice="$8.49" }} -->
                  ...
                  <div class="col">
                     <!-- {{> partials/components/category-menu categoryImage="15.png" categoryTitle="Spaghetti" rating="3" oldPrice="$7.29" }} -->
                     <categorymenu :categoryImage="require('@/assets/images/layouts/15.png')" categoryTitle="Spaghetti" :rating="3" oldPrice="$7.29" />
                  </div>
                  <div class="col">
                     <!-- {{> partials/components/category-menu categoryImage="14.png" categoryTitle="Vegetable" rating="3"  active="active" oldPrice="$5.49" }} -->
                     <categorymenu :categoryImage="require('@/assets/images/layouts/14.png')" categoryTitle="Vegetable" :rating="3" oldPrice="$5.49"/>
                  </div>
                  <div class="col">
                     <!-- {{> partials/components/category-menu categoryImage="12.png" categoryTitle="Sweets" rating="3" oldPrice="$6.49" }} -->
      ...
      <div class="card my-cart-card">
         <div class="card-header d-flex align-items-center justify-content-between pb-0  border-bottom-0">
            ...
            <svg width="19" height="19" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M20.9909 1.50781L1.01172 21.487" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
               <path d="M20.9958 21.5L1 1.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
         </div>
         <div class="card-body">
            ...
            <div class="my-cart-body">
               <div class="border border-primary rounded p-3 mt-5">
                  ...
                  <div class="d-flex justify-content-between align-items-center ">
                     ...
                     <h6 class="heading-title fw-bolder text-primary">$50.49</h6>
                  </div>
               </div>
