            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="d-grid gap-card grid-cols-2 ">
                        <img src="~@/assets/images/layouts/29.png" alt="post-image" class="img-fluid rounded-1" >
                        <img src="~@/assets/images/layouts/30.png" alt="post-image" class="img-fluid rounded-1" >
                    </div>
                    <img src="~@/assets/images/layouts/31.png" alt="post-image" class="img-fluid mt-4 rounded-1" >
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-12 col-xl-9 col-lg-8">
        <div class="card">
            <div class="card-header ">
               <h4 class="card-title list-main">Our Specials</h4>
            </div>
            <div class="card-body ">
                <Swipernew :options="newoptions4" className="swiper d-slider4 dish-card-horizontal">
                    <SwiperSlide>
                        <categorymenu :categoryImage="require('@/assets/images/layouts/33.png')" categoryTitle="Cheese pizza" oldPrice="$7.49" categoryPrice="$8.49"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <categorymenu :categoryImage="require('@/assets/images/layouts/23.png')" categoryTitle="pizza" oldPrice="$7.49" categoryPrice="$8.49"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <categorymenu :categoryImage="require('@/assets/images/layouts/35.png')" categoryTitle="Onion pizza" oldPrice="$7.49" categoryPrice="$8.49"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <categorymenu :categoryImage="require('@/assets/images/layouts/36.png')" categoryTitle="Veggie pizza" oldPrice="$7.49" categoryPrice="$8.49"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <categorymenu :categoryImage="require('@/assets/images/layouts/28.png')" categoryTitle="Pasta pizza" active="active" oldPrice="$7.49" categoryPrice="$8.49"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <categorymenu :categoryImage="require('@/assets/images/layouts/25.png')" categoryTitle="Spaghetti" oldPrice="$7.49" categoryPrice="$8.49"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <categorymenu :categoryImage="require('@/assets/images/layouts/26.png')" categoryTitle="Vegetable" oldPrice="$7.49" categoryPrice="$8.49"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <categorymenu :categoryImage="require('@/assets/images/layouts/27.png')" categoryTitle="Sweets" oldPrice="$7.49" categoryPrice="$8.49"/>
                    </SwiperSlide>
                </Swipernew>
            </div>
        </div>
    ...
    <div class="col-md-12 col-xl-3 col-lg-4">
        <div class="card">
            ...
            <div class="card-body py-3">
             ...
             <customer-review :custumerImage="require('@/assets/images/menu/1.png')" custumerTitle="Jane Coper" custumersubTitle="1 Day ago" :rating="2" custumerText="Nice place for having snacks." />
             </div>
             </div>
             <div class="card rounded-1 mb-3 cusomer-card">
                    <div class="card-body px-2 py-2 menu-image">
            <customer-review :custumerImage="require('@/assets/images/menu/2.png')" custumerTitle="Tom Potter" custumersubTitle="1 Day ago" :rating="3" custumerText="NiceNice service and delicious food.." />
            </div>
            </div>
            <div class="card rounded-1 mb-0 cusomer-card pb-0">
                    <div class="card-body px-2 py-2 menu-image">
            <customer-review :custumerImage="require('@/assets/images/menu/3.png')" custumerTitle="Mira James" custumersubTitle="1 Day ago" :rating="3" custumerText="Love the environment and food."/>
            </div>
            </div>
            </div>
        </div>
