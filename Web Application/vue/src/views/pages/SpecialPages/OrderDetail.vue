               ...
               <div class="card-body p-0">
                  <div class="p-4 border-bottom">
                     <div class="text-center">
                           <img src="@/assets/images/order-details/1.png" class="img-fluid avatar-rounded avatar-100" alt="profile-image">
                           <h6 class="mt-3 heading-title fw-bolder">Robert Fox</h6>
                     ...
                     <div class="d-flex mt-4">
                           ...
                           <span class="mb-0 ms-3 fw-bolder text-primary">(480) 555-0103</span>
                     </div>
                     <div class="d-flex mt-3 ">
                           ...
                           <span class="mb-0 ms-3 text-dark fw-bolder">6391 Elgin St. Celina, Delaware 10299</span>
                     </div>
                  </div>
                  <div class="p-4">
                     <h6 class="heading-title fw-bolder">Note order</h6>
                     <p class="mb-0 mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  </div>
               </div>
         </div>
         <div class="card ">
               <div class="card-body">
                  <div class="text-center">
                     <h4 class="fw-bolder mb-2">Delivery Guy</h4>
                     <img src="@/assets/images/order-details/2.png" class="img-fluid avatar-rounded avatar-100 mt-5" alt="profile-image">
                     <h6 class="mt-3 heading-title fw-bolder"> Robert Fox</h6>
                  </div>
                  <div class="d-flex mt-4">
                     <svg width="19" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="card-body px-2">
                  <div class="row">
                     <div class="col-md-6  mb-4 mb-md-0">
                           <!-- <div id="circle-progress-01" class="circle-progress-01 circle-progress circle-progress-primary text-center" data-min-value="0" data-max-value="100" data-value="66" data-type="percent">
                           </div> -->
                           <CircleProgress :value="66" color="primary" className="text-center"/>
                           <div class="text-center mt-4">
                              <h6 class="heading-title fw-bolder">Food</h6>
                              <h6 class="heading-title fw-bolder">45 menus</h6>
                           </div>
                     </div>
                     <div class="col-md-6">
                           <!-- <div id="circle-progress-02" class="circle-progress-02 circle-progress circle-progress-success text-center" data-min-value="0" data-max-value="100" data-value="31" data-type="percent">
                           </div> -->
                           <CircleProgress :value="31" color="success" className="text-center" />
                           <div class="text-center mt-4">
                              <h6 class="heading-title fw-bolder">Drink</h6>
                              <h6 class="heading-title fw-bolder">21 menus</h6>
                           </div>
                     </div>
                  </div>
               </div>
               ...
               <table class="table table-borderless product-table rounded">
                  ...
                  <tbody>
                     <tr class="cart_item border-bottom">
                           <td>
                              <div class="d-flex align-items-center">
                                 <img src="@/assets/images/order-details/5.png" class="img-fluid avatar-rounded avatar-70" alt="profile-image">
                                 <div class="d-flex ms-4">
                                       <div>
                                          <h6 class="heading-title text-primary">Main Course</h6>
                                          <p class="mb-0 fw-bolder">Panner curry special with</p><br>
                                          cucumber
                     ...
                     <tr class="cart_item border-bottom">
                           <td>
                              <div class="d-flex align-items-center">
                                 <img src="@/assets/images/order-details/3.png" class="img-fluid avatar-rounded avatar-70" alt="profile-image">
                                 <div class="d-flex ms-4">
                                       <div>
                     ...
                     <tr class="cart_item">
                           <td>
                              <div class="d-flex align-items-center">
                                 <img src="@/assets/images/order-details/4.png" class="img-fluid avatar-rounded avatar-70" alt="profile-image">
                                 <div class="d-flex ms-4">
                                       <div>
                                          <h6 class=" heading-title text-primary">Main Course</h6>
         ...
         <div class="card">
               <div class="card-body">
                  <div class="header-title d-flex justify-content-between mb-4">
                     <h4 class="card-title">Track your order</h4>
                     <small class="text-primary mb-0">Expected in 45 mins</small>
                  </div>
