    ...
    <div class="col-lg-8">
        <div class="card mb-3" data-iq-gsap="onStart"
            ...
            <div class="card-body">
                ...
                <a href="#" class="">Irish Restaurants</a>
                <div class="mt-2 mb-3">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="#dining" class="nav-link" id="dining-tab" data-bs-toggle="tab" data-bs-target="#dining" role="tab" aria-selected="false">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <span class="text-dark">Dining Out</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="#nightlife" class="nav-link" id="nightlife-tab" data-bs-toggle="tab" data-bs-target="#nightlife" role="tab" aria-selected="false">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <span class="text-dark">NightLife</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="#nutririon" class="nav-link" id="nutririon-tab" data-bs-toggle="tab" data-bs-target="#nutririon" role="tab" aria-selected="false">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <span class="text-dark">Nutririon</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="mt-3 iq-fetch">
                    <button type="button" class="btn btn-outline-secondary rounded-1 iq-fetch-details">Filters</button>
                    <button type="button" class="btn btn-outline-secondary rounded-1 iq-fetch-details">Rating: 4.0+</button>
                    <button type="button" class="btn btn-outline-secondary rounded-1 iq-fetch-details">Safe and Hygienic</button>
                    <button type="button" class="btn btn-outline-primary rounded-1 iq-fetch-details">Pure Veg</button>
                    <button type="button" class="btn btn-outline-secondary rounded-1 iq-fetch-details">Delivery Time</button>
                    <button type="button" class="btn btn-outline-secondary rounded-1 iq-fetch-details">Great Offers</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="text-center ">
                    <div class="profile-img40 ">
                        <img src="@/assets/images/restaurant/01.png" class="img-fluid rounded-pill" alt="profile-image">
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between pb-3 ">
                    <div>
                        ...
                        <span class="text-dark">9.30AM - 11.30PM<br>
                            (Today)
                        </span >
                    </div>
                    <img src="@/assets/images/restaurant/02.png" class="img-fluid rounded avatar-160" alt="profile-image">
                </div>
                <div class="iq-share-btn">
                    ...
                    <path d="M8.26953 9.02762H15.5878" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Bookmark</button>
        ...
        <div class="card" data-iq-gsap="onStart"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between pb-3 ">
                    ...
                    <img src="@/assets/images/restaurant/03.png" class="img-fluid rounded avatar-160" alt="profile-image">
                </div>
                <div class="iq-share-btn">
                    <button type="button" class="btn btn-primary rounded-pill mt-3 me-2">
                    <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="20px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button type="button" class="btn bg-white rounded-pill mt-3 me-2 share-btn-white">
                    <svg width="20px"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M19.7381 6.15344C19.7381 3.40256 17.8574 2.2998 15.1496 2.2998H8.7907C6.16614 2.2998 4.19922 3.32737 4.19922 5.96998V20.6938C4.19922 21.4196 4.98017 21.8767 5.61275 21.5219L11.9947 17.9419L18.3215 21.5158C18.9551 21.8727 19.7381 21.4156 19.7381 20.6888V6.15344Z" stroke="#EA6A12" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M8.26953 9.02762H15.5878" stroke="#EA6A12" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Bookmark</button>
                    <button type="button" class="btn bg-white rounded-pill mt-3  share-btn-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="row">
        ...
        <div class="card" data-iq-gsap="onStart"
            ...
            <div class="card-body py-0">
                <ul class="list-inline list-main iq-special-product">
                    ...
                    <li class="py-3 d-flex align-items-center">
                     <img src="@/assets/images/restaurant/05.png" class="img-fluid rounded-circle avatar-45" alt="profile-image">
                    <div class="ms-3">
                    ...
                    <li class="py-3 d-flex align-items-center">
                     <img src="@/assets/images/restaurant/06.png" class="img-fluid rounded-circle avatar-45" alt="profile-image">
                    <div class="ms-3">
                    ...
                    <li class="py-3 d-flex align-items-center">
                     <img src="@/assets/images/restaurant/07.png" class="img-fluid rounded-circle avatar-45" alt="profile-image">
                    <div class="ms-3">
    ...
    <div class="col-lg-5">
        <div class="card" data-iq-gsap="onStart"
            ...
            <div class="card-header">
                <div class="header-title">
                    <h4 class="card-title">Other Branches</h4>
                </div>
            </div>
            <div class="card-body iq-other-branch">
                <div class="d-flex iq-branch justify-content-between pb-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <small class="text-dark ms-1">4.5</small>
                    </div>
                </div>
                 <div class="d-flex iq-branch justify-content-between pb-3 pt-3">
                    <div class="text-dark">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
    ...
    <div class="col-lg-4">
        <div class="card"
            ...
            <div class="card-body">
                <div class="iq-other-branch">
                    <div class="iq-branch pb-3">
                        <div class="d-flex align-items-center mb-2">
                            <img src="@/assets/images/restaurant/09.png" class="img-fluid rounded-circle avatar-40 me-2" alt="">
                            <div class="media-support-info">
                                <h6 class="mb-0 heading-title fw-bolder">Jane Cooper</h6>
                            </div>
                        </div>
                        <div class="media-support-body">
                            <p class=" text-ellipsis short-3">
                ...
                <div class="mt-3">
                    <div class="d-flex align-items-center mb-2">
                    <img src="@/assets/images/restaurant/10.png" class="img-fluid rounded-circle avatar-40 me-2" alt="">
                    <div class="media-support-info">
                        <h6 class="mb-0 heading-title fw-bolder">Guy Hawkins</h6>
                    </div>
                    </div>
                    <div class="media-support-body">
                   <p  class=" text-ellipsis short-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type.</p>
                    <a href="#" class="">Read More</a>
                    </div>
                </div>
            </div>
