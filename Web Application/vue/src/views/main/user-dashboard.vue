<template>
   <div class="row">
      <div class="col-md-12 col-lg-8">
         ...
         data-iq-ease="none"
         >
            <div class="hero-image p-3" :style= "`background: url(${require('@/assets/images/layouts/01.png')}); no-repeat center right;background-size: cover;background-position: center;`">
               ...
               class="d-slider2">
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="@/assets/images/layouts/1.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <SwiperSlide>
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="@/assets/images/layouts/2.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <SwiperSlide>
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="@/assets/images/layouts/3.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <SwiperSlide>
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="@/assets/images/layouts/4.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <SwiperSlide>
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="@/assets/images/layouts/5.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <SwiperSlide>
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="@/assets/images/layouts/6.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <SwiperSlide>
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="@/assets/images/layouts/7.png" alt="header" class="img-fluid rounded-pill mb-3">
               ...
               <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
                  <div class="row row-cols-1 row-cols-md-2 row-cols-xl-2 row-cols-xxl-4">
                     <div class="col active"
                        ...
                        data-iq-ease="none"
                     >
                        <categorymenu :categoryImage="require('@/assets/images/layouts/16.png')" categoryTitle="Mushroom" :rating="3" oldPrice="$7.49" categoryPrice="$8.49"/>
                     </div>
                     <div class="col"
                     data-iq-gsap="onStart"
                        data-iq-opacity="0"
                        ...
                        data-iq-ease="none"
                     >
                        <categorymenu :categoryImage="require('@/assets/images/layouts/15.png')" categoryTitle="Spaghetti" :rating="3" oldPrice="$7.29" />
                     </div>
                     <div class="col"
                     data-iq-gsap="onStart"
                        data-iq-opacity="0"
                        ...
                        data-iq-ease="none"
                     >
                        <categorymenu :categoryImage="require('@/assets/images/layouts/14.png')" categoryTitle="Vegetable" :rating="3" oldPrice="$5.49"/>
                     </div>
                     <div class="col"
                     data-iq-gsap="onStart"
                        data-iq-opacity="0"
                        ...
                        data-iq-ease="none"
                     >
                        <categorymenu :categoryImage="require('@/assets/images/layouts/12.png')" categoryTitle="Sweets" :rating="3" oldPrice="$6.49"/>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="card-transparent bg-transparent mb-0">
            <div class="card-header border-0 m-2 mb-5">
             ...
             <div class="card-body p-0 dish-card-vertical">
               ...
               @swiper="onSwiper"
               @slideChange="onSlideChange"  class="swiper d-slider3">
                  <SwiperSlide
                        data-iq-gsap="onStart"
                        data-iq-opacity="0"
                        data-iq-position-y="-40"
                        ...
                        data-iq-ease="none"
                     >
                        <trendingorder :trendingImage="require('@/assets/images/layouts/17.png')" trendingDay="Top of the week" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49" />
                        <trendingorder :trendingImage="require('@/assets/images/layouts/19.png')" trendingDay="Top of the week" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49" />
                  </SwiperSlide>
                  <SwiperSlide
                     data-iq-gsap="onStart"
                     data-iq-opacity="0"
                     ...
                     data-iq-ease="none"
                  >
                     <trendingorder :trendingImage="require('@/assets/images/layouts/14.png')" trendingDay="Top of the day" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49" />
                     <trendingorder :trendingImage="require('@/assets/images/layouts/20.png')" trendingDay="Top of the month" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49" />
                  </SwiperSlide>
                  <SwiperSlide
                     data-iq-gsap="onStart"
                     data-iq-opacity="0"
                     ...
                     data-iq-ease="none"
                  >
                     <trendingorder :trendingImage="require('@/assets/images/layouts/18.png')" trendingDay="Top of the month" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49" />
                     <trendingorder :trendingImage="require('@/assets/images/layouts/21.png')" trendingDay="Top of the day" trendingTitle="Italian Salad" trendingCalories="60 Calories" trendingPersons="4 persons" trendingPrice="$7.49" />
                  </SwiperSlide>
                  <SwiperSlide
                     data-iq-gsap="onStart"
                     data-iq-opacity="0"
         ...
         <div class="row">
                  ...
                  <div class="card-body">
                     <div class="text-center profile-img51">
                        <div class="profile-img41 ">
                           <img src="@/assets/images/layouts/8.png" class="img-fluid rounded-pill " alt="profile-image">
                        </div>
                  ...
                  <div class="card-body">
                     <div class="rounded-pill bg-soft-primary iq-my-cart">
                        <div class="d-flex align-items-center justify-content-between profile-img4">
                           <div class="profile-img11">
                              <img src="@/assets/images/layouts/13.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                              <img src="@/assets/images/layouts/13.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                              data-iq-gsap="onStart"
                              data-iq-opacity="0"
                              data-iq-scale=".6"
                              data-iq-rotate="180"
                     ...
                     <div class="rounded-pill bg-soft-primary iq-my-cart">
                        <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                           <div class="profile-img11">
                              <img src="@/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                              <img src="@/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                              data-iq-gsap="onStart"
                              data-iq-opacity="0"
                              data-iq-scale=".6"
                              data-iq-rotate="180"
                     ...
                     <div class="rounded-pill bg-soft-primary iq-my-cart">
                        <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                           <div class="profile-img11">
                              <img src="@/assets/images/layouts/11.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                              <img src="@/assets/images/layouts/11.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                              data-iq-gsap="onStart"
                              data-iq-opacity="0"
                              data-iq-scale=".6"
                              data-iq-rotate="180"
                     ...
                     <div class="text-center mt-5">
                        <a type="button" href="@/dashboard/special-pages/add-to-cart.html" class="btn btn-primary rounded-pill">Checkout</a>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-md-12 col-lg-12">
               ...
               <div class="position-relative">
                     <img src="@/assets/images/layouts/40.png" alt="img-1" class="img-fluid img-user">
                  </div>
            </div>
         </div>
      </div>
...
<script>
import gsapInit from '@/plugins/animation/gsap-init'
