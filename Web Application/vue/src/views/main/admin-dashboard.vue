        ...
        <div class="col-lg-7 col-xl-8">
            ...
            <div class="row">
                <div class="col-lg-12 col-xl-8">
                        ...
                        data-iq-ease="none">
                            <div class="card-body">
                    <tab-nav :tabs="true" extraclass="mb-4 nav-justified product-tab" id="myTabs" role="tablist">
                            <tab-nav-items :atag="false" mainRole="presentation">
                        ...
                        <tab-content id="myTabContent">
                            <tab-content-item :className="false" :active="true" id="product">
                                <h3>Products Sale</h3>
            ...
            <div class="card" >
                ...
                <div class="card-body ">
                    <Swipernew :options="newoptions5" className="d-slider5">
                        <SwiperSlide slideClass="text-center"
                        data-iq-gsap="onStart"
                    data-iq-opacity="0"
                    data-iq-position-y="-40"
                    data-iq-duration=".6"
                    ...
                    data-iq-trigger="scroll"
                    data-iq-ease="none">
                        <circleprogressbar :id="1" color="primary" :value="65" :image="require('@/assets/images/layouts/13.png')" imgClass="circle-image" progressPercent="65%" progresssTitle="Mix Vaggie Pizza"  />
                        </SwiperSlide>
                        <SwiperSlide slideClass="text-center" data-iq-gsap="onStart"
                    data-iq-opacity="0"
                    data-iq-position-y="-40"
                    data-iq-duration=".6"
                    data-iq-delay=".5"
                    data-iq-trigger="scroll"
                    data-iq-ease="none">
                        <circleprogressbar :id="2" color="primary" :value="50" :image="require('@/assets/images/layouts/11.png')" imgClass="circle-image" progressPercent="50%" progresssTitle="Sausage Pizza" />
                        </SwiperSlide>
                        <SwiperSlide slideClass="text-center"  data-iq-gsap="onStart"
                    data-iq-opacity="0"
                    data-iq-position-y="-40"
                    ...
                    data-iq-trigger="scroll"
                    data-iq-ease="none">
                        <circleprogressbar :id="3" color="primary" :value="55" :image="require('@/assets/images/layouts/12.png')" imgClass="circle-image" progressPercent="55%" progresssTitle="Shrikhand" />
                        </SwiperSlide>
                        <SwiperSlide slideClass="text-center" data-iq-gsap="onStart"
                    data-iq-opacity="0"
                    data-iq-position-y="-40"
                    ...
                    data-iq-trigger="scroll"
                    data-iq-ease="none">
                            <circleprogressbar :id="4" color="primary" :value="55" :image="require('@/assets/images/layouts/10.png')" imgClass="circle-image" progressPercent="55%" progresssTitle="Pasta" />
                        </SwiperSlide>
                        <SwiperSlide slideClass="text-center" data-iq-gsap="onStart"
                    data-iq-opacity="0"
                    data-iq-position-y="-40"
                    ...
                    data-iq-trigger="scroll"
                    data-iq-ease="none">
                            <circleprogressbar :id="5" color="primary" :value="65" :image="require('@/assets/images/layouts/13.png')" imgClass="circle-image" progressPercent="65%" progresssTitle="Pasta pizza" />
                        </SwiperSlide>
                    </Swipernew>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-12 mt-3 mt-lg-0">
                            ...
                            <Progressbar :value="85" color="primary" class="shadow-none w-100" colorName="primary" style="height: 8px"/>
                        </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <Progressbar :value="67" color="primary" class="shadow-none w-100" colorName="primary" style="height: 8px"/>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-5">
                        <div class="me-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <Progressbar :value="40" color="primary" class="shadow-none w-100" colorName="primary" style="height: 8px"/>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-5">
                        <div class="me-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <Progressbar :value="90" color="primary" class="shadow-none w-100" colorName="primary" style="height: 8px"/>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-5">
                        <div class="me-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <Progressbar :value="50" color="primary" class="shadow-none w-100" colorName="primary" style="height: 8px"/>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-5">
                        <div class="me-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <Progressbar :value="37" color="primary" class="shadow-none w-100" colorName="primary" style="height: 8px"/>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="me-3">
...
import apchart from '@/assets/js/charts/admin'
export default {
