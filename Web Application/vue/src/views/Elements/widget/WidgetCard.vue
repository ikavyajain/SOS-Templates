                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex  justify-content-start align-items-center mb-3">
                            <div class="pe-3">
                                <img src="@/assets/images/avatars/02.png" class="rounded-circle p-1 bg-soft-danger" width="60" height="60" alt="1">
                            </div>
                            <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="pe-3">
                                <img src="@/assets/images/avatars/03.png" class="rounded-circle bg-soft-primary p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="@/assets/images/avatars/04.png" class="rounded-circle bg-soft-danger p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="@/assets/images/avatars/05.png" class="rounded-circle bg-soft-info p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="@/assets/images/avatars/02.png" class="rounded-circle bg-soft-danger p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <ul class="media-story m-0 p-0">
                            <li class="d-flex mb-4 align-items-center active">
                                <img src="@/assets/images/avatars/04.png" alt="story-img" class="avatar-50 rounded-circle p-1 bg-soft-danger img-fluid">
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <img src="@/assets/images/avatars/02.png" alt="story-img" class="avatar-50 rounded-circle p-1 bg-soft-danger img-fluid">
                                <div class="stories-data ms-3">
                                    <h5>Ira Membrit</h5>
                            ...
                            <li class="d-flex align-items-center">
                                <img src="@/assets/images/avatars/03.png" alt="story-img" class="avatar-50 rounded-circle p-1 bg-soft-primary img-fluid">
                                <div class="stories-data ms-3">
                                    <h5>Bob Frapples</h5>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-card grid-cols-3">
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/01.png')">
                                <img src="@/assets/images/icons/01.png" class="img-fluid bg-soft-info rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/02.png')">
                                <img src="@/assets/images/icons/02.png" class="img-fluid bg-soft-primary rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/03.png')">
                                <img src="@/assets/images/icons/03.png" class="img-fluid bg-soft-info rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/04.png')">
                                <img src="@/assets/images/icons/04.png" class="img-fluid bg-soft-primary rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/05.png')">
                                <img src="@/assets/images/icons/05.png" class="img-fluid bg-soft-warning rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/06.png')">
                                <img src="@/assets/images/icons/06.png" class="img-fluid bg-soft-primary rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/07.png')">
                                <img src="@/assets/images/icons/07.png" class="img-fluid bg-soft-danger rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/08.png')">
                                <img src="@/assets/images/icons/08.png" class="img-fluid bg-soft-primary rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" :href="require('@/assets/images/icons/01.png')">
