            ...
            <div class="col-lg-6">
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <toast :ariaatomic="true" buttonClass="ms-2 mb-1">
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <toast extraClass="mb-2" :ariaatomic="true" buttonClass="ms-2 mb-1">
                        <toast-header :dismissable="true">
                             <svg class="bd-placeholder-img rounded me-2" width="20" height="20" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img">
                              <rect width="100%" height="100%" fill="#007aff"></rect>
                           </svg>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <div class="p-3 bg-dark">
                        ...
                        <toast-body>
                            H  Hello, world! This is a toast message.
                        </toast-body>
                     </toast>
                        </div>
                     </div>
                  ...
                  <div class="card-body">
                     ...
                     <div class="bg-dark p-3">
                        <div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 200px;">
                            <toast style="position: absolute; top: 0; right: 0;" buttonClass="ms-2 mb-1">
                        <toast-header :dismissable="true">
                               <svg class="bd-placeholder-img rounded me-2" width="20" height="20" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img">
                                    <rect width="100%" height="100%" fill="#007aff"></rect>
                                 </svg>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <div class="d-flex justify-content-around">
                          <toast extraClass="bg-primary text-white border-0" :ariaatomic="true" >
                        <toast-header :dismissable="true" headerClass="bg-primary text-white" buttonClass="btn-close-white" >
                             <svg class="bd-placeholder-img rounded me-2" width="20" height="20" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img">
                        ...
                        <toast-body>
                             ...
                             <toast extraClass="bg-success text-white border-0" :ariaatomic="true" buttonClass="ms-2 mb-1 btn-close-white text-white ">
                        <toast-header :dismissable="true" headerClass="bg-success text-white" buttonClass="btn-close-white">
                             <svg class="bd-placeholder-img rounded me-2" width="20" height="20" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img">
                                 <rect width="100%" height="100%" fill="#fff"></rect>
                              </svg>
                              <strong class="me-auto text-white">Bootstrap</strong>
...
<script>
import ToastBody from '../../../components/bootstrap/toasts/toast-body.vue'
import ToastHeader from '../../../components/bootstrap/toasts/toast-header.vue'
import toast from '../../../components/bootstrap/toasts/toast.vue'
export default {
  components: { toast, ToastHeader, ToastBody },
  name: 'UiNotification'
}
</script>
