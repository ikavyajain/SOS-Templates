            ...
            <template v-slot:body>
               <form id="form-wizard1" class="text-center mt-3">
                  ...
                  <fieldset :class="current == 1 ? 'd-block' : 'd-none'">
                     ...
                     <button type="button" name="next" @click="changeTab(2)" class="btn btn-primary next action-button float-end rounded" value="Next" >Next</button>
                  </fieldset>
                  <fieldset :class="current == 2 ? 'd-block' : 'd-none'">
                     ...
                     <button type="button" name="next" @click="changeTab(3)" class="btn btn-primary next action-button float-end rounded" value="Next" >Next</button>
                     <button type="button" name="previous" @click="changeTab(1)" class="btn btn-dark previous action-button-previous float-end me-1 rounded" value="Previous" >Previous</button>
                  </fieldset>
                  <fieldset :class="current == 3 ? 'd-block' : 'd-none'">
                     ...
                     <button type="button" name="next" @click="changeTab(4)" class="btn btn-primary next action-button float-end rounded" value="Submit" >Submit</button>
                     <button type="button" name="previous" @click="changeTab(2)" class="btn btn-dark previous action-button-previous float-end me-1 rounded" value="Previous" >Previous</button>
                  </fieldset>
