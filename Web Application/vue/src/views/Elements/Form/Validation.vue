            ...
            <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <form :class="`row g-3 needs-validation ${validateClass}`" novalidate="">
                        ...
                        <div class="col-12">
                           <button class="btn btn-primary rounded" type="button" @click="Submitcustom">Submit form</button>
                        </div>
                     </form>
                  </div>
               </div>
            <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <form :class="`row g-3 needs-validation ${validateClass1}`" novalidate="">
                        ...
                        <div class="col-12">
                           <button  class="btn btn-primary rounded" type="button"  @click="Submitcustom1">Submit form</button>
                        </div>
                     </form>
                  </div>
            </div>
