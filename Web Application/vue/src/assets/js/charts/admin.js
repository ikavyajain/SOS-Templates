...
export default () => {
  ...
  if (document.querySelectorAll('#admin-chart-1').length) {
    const options = {
      series: [{
        type: 'column',
  ...
  if (document.querySelectorAll('#admin-chart-2').length) {
    let data = []
    const options = {
      series: [{
        name: 'Food',
  ...
  if (document.querySelectorAll('#admin-chart-3').length) {
    let data = []
    const options = {
      series: [{
        name: 'Food',
  ...
  if (document.querySelectorAll('#admin-chart-4').length) {
    const options = {
      series: [{
        name: 'Total sales',
        data: [10, 10, 35, 10]
  ...
  if (document.querySelectorAll('#admin-chart-5').length) {
    const options = {
      series: [{
        name: 'Total Profit',
        data: [10, 10, 35, 10]
  ...
  if (document.querySelectorAll('#admin-chart-6').length) {
    const options = {
      series: [{
        name: 'Food',
  ...
  if (document.querySelectorAll('#admin-chart-7').length) {
    const options = {
      series: [{
        name: 'Product',
  ...
  if (document.querySelectorAll('#admin-chart-8').length) {
    const options = {
      series: [{
        name: 'Total sales',
        data: [10, 10, 25, 10]
