            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item" >
                    ...
                    <Accordion.Collapse eventKey="horizontal-menu" >
                        <ul  className="sub-nav">
                            ...
                            <li className="nav-item">
                                    <Link className={`${location.pathname === '/admin' ? 'active' : ''} nav-link`}  to="/admin">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/restaurant' ? 'active' : ''} nav-link`}  to="/restaurant">
                                    ...
                                    <span className="item-name">Restaurant</span>
                                </Link>
                            </li>
                        </ul>
                    </Accordion.Collapse>
                ...
                <CustomToggle eventKey="sidebar-special" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/special-pages/dish-details' ? 'active' : ''} nav-link`} to="/special-pages/dish-details">
                                <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <span className="item-name">Dish detail</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/special-pages/add-to-cart' ? 'active' : ''} nav-link`} to="/special-pages/add-to-cart">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i className="sidenav-mini-icon"> A </i>
                                    <span className="item-name">Add To cart</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/special-pages/order-history' ? 'active' : '' } nav-link`} to="/special-pages/order-history">
                                    <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Order History</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/special-pages/order-detail' ? 'active' : ''} nav-link`} to="/special-pages/order-detail">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i className="sidenav-mini-icon"> O </i>
                                    <span className="item-name"> Order Detail </span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/special-pages/menu' ? 'active' : ''} nav-link`} to="/special-pages/menu">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/special-pages/customer-review' ? 'active' : ''} nav-link`} to="/special-pages/customer-review">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Customer Review</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/special-pages/restaurant-detail' ? 'active' : ''} nav-link`} to="/special-pages/restaurant-detail">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i className="sidenav-mini-icon"> R </i>
                                    <span className="item-name">restaurant Detail</span>
                                </Link>
                            </li>
                        </ul>
                    </Accordion.Collapse>
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix="nav-item">
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/app/user-profile' ? 'active' : ''} nav-link`} to="/app/user-profile">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-UiElements" bsPrefix="nav-item">
                    <CustomToggle eventKey="sidebar-UiElements" active={activeMenu === 'sidebar-UiElements' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                        <i className="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                    ...
                    <Accordion.Collapse eventKey="sidebar-UiElements">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/avatars' ? 'active' : ''} nav-link`} to="/avatars">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/alerts' ? 'active' : ''} nav-link`} to="/alerts">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/badges' ? 'active' : ''} nav-link`} to="/badges">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/breadcrumb' ? 'active' : ''} nav-link`} to="/breadcrumb">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/buttons' ? 'active' : ''} nav-link`} to="/buttons">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/button-group' ? 'active' : ''} nav-link`} to="/button-group">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/box-shadow' ? 'active' : ''} nav-link`} to="/box-shadow">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/colors' ? 'active' : ''} nav-link`} to="/colors">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/cards' ? 'active' : ''} nav-link`} to="/cards">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/carousel' ? 'active' : ''} nav-link`} to="/carousel">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/grid' ? 'active' : ''} nav-link`} to="/grid">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/helper-classes' ? 'active' : ''} nav-link`} to="/helper-classes">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/images' ? 'active' : ''} nav-link`} to="/images">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/list-group' ? 'active' : ''} nav-link`} to="/list-group">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/modal' ? 'active' : ''} nav-link`} to="/modal">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/notifications' ? 'active' : ''} nav-link`} to="/notifications">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/pagination' ? 'active' : ''} nav-link`} to="/pagination">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/popovers' ? 'active' : ''} nav-link`} to="/popovers">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/typography' ? 'active' : ''} nav-link`} to="/typography">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/tabs' ? 'active' : ''} nav-link`} to="/tabs">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/tooltips' ? 'active' : ''} nav-link`} to="/tooltips">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-widget" bsPrefix="nav-item">
                    ...
                    <Accordion.Collapse eventKey="sidebar-widget">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/widget/widgetbasic' ? 'active' : ''} nav-link`} to="/widget/widgetbasic">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/widget/widgetchart' ? 'active' : ''} nav-link`} to="/widget/widgetchart">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/widget/widgetcard' ? 'active' : ''} nav-link`} to="/widget/widgetcard">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <CustomToggle eventKey="sidebar-maps" active={activeMenu === 'sidebar-maps' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-maps">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/map/google' ? 'active' : ''} nav-link`} to="/map/google">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-form" bsPrefix="nav-item">
                 <CustomToggle eventKey="sidebar-form" active={activeMenu === 'sidebar-form' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-form" >
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/form/form-element' ? 'active' : ''} nav-link`} to="/form/form-element">
                                <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/form/form-wizard' ? 'active' : ''} nav-link`} to="/form/form-wizard">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/form/form-validation' ? 'active' : ''} nav-link`} to="/form/form-validation">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-table" bsPrefix="nav-item">
                 <CustomToggle eventKey="sidebar-table" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-table">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/table/bootstrap-table' ? 'active' :''} nav-link`} to="/table/bootstrap-table">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/table/table-data' ? 'active' : ''} nav-link`} to="/table/table-data">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <CustomToggle eventKey="sidebar-icons" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-icons">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/icon/solid' ? 'active' : ''} nav-link`} to="/icon/solid">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/icon/outline' ? 'active' : ''} nav-link`} to="/icon/outline">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/icon/dual-tone' ? 'active' : ''} nav-link`} to="/icon/dual-tone">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
