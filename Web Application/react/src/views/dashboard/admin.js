...
import admin08 from '../../assets/images/admin/08.png'
import admin09 from '../../assets/images/admin/09.png'
import admin10 from '../../assets/images/admin/10.png'
import admin11 from '../../assets/images/admin/11.png'
import admin12 from '../../assets/images/admin/12.png'
import avt10 from '../../assets/images/avatars/10.png'
import avt06 from '../../assets/images/avatars/06.png'
                            ...
                            <Swiper
                                ...
                                breakpoints={{
                                    ...
                                    <div className="text-center">
                                        ...
                                        <h6 className="heading-title fw-bolder">Mix Veggie Pizza</h6>
                                    </div>
                                    </SwiperSlide>
                                    <SwiperSlide className="text-center" 
                                    data-iq-gsap="onStart"
                                    ...
                                    <tbody>
                                        <tr >
                                            <td>
                                                ...
                                                <img className="bg-soft-primary rounded img-fluid avatar-40 me-3" src={avt06} alt="profile"/>
                                                <p className="mb-0">Darrell Steward</p>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                <img className="bg-soft-primary rounded img-fluid avatar-40 me-3" src={avt07} alt="profile"/>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                <img className="bg-soft-primary rounded img-fluid avatar-40 me-3" src={avt08} alt="profile"/>
                                                <p className="mb-0">Esther Howard</p>
                                                </div>
                                            </td>
                                            <td>
                                                2464 Royal Ln. Mesa
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                <img className="bg-soft-primary rounded img-fluid avatar-40 me-3" src={avt09} alt="profile"/>
                                                <p className="mb-0">Jacob Jones</p>
                                                </div>
                                            </td>
                                            <td>
                                                6391 Elgin St. Celina
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                <img className="bg-soft-primary rounded img-fluid avatar-40 me-3" src={avt10} alt="profile"/>
                                                <p className="mb-0">Jane Cooper</p>
                                                </div>
                                            </td>
                                            <td>
                ...
                <Col lg="5" xl="4">
                    <div className="card card-primary" data-iq-gsap="onStart"
                        ...
                        <Card.Body className="d-flex align-items-center justify-content-between">
                            <Col>
                                ...
                                <Link to="#" className="btn bg-white rounded-pill">View More</Link>
                            </Col>
                            <Card className="col-2 mb-0 bg-white card-body">
                                <div>
                                ...
                                <Chart id="admin-chart-8" options={chart2.options} series={chart2.series} type="line"  width="130" height="70" />
                                    ...
                                    <h6 className="heading-title text-primary text-center mt-3">+0.4% <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.77083 3.54199L9.77083 16.042" stroke="#EA6A12" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                        <path d="M4.75213 8.58301L9.77213 3.54134L14.793 8.58301" stroke="#EA6A12" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </h6>
                    ...
                    <div className="card" data-iq-gsap="onStart"
                        ...
                        <Card.Body>
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <div className="d-flex align-items-center">
                                    <img src={admin01} className="img-fluid rounded-pill avatar-50" alt="1"/>
                                    <div className="ms-3">
                                        <h6 className="heading-title fw-bolder mb-2">Sausage Pizza</h6>
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <div className="d-flex align-items-center">
                                    <img src={admin02} className="img-fluid rounded-pill avatar-50" alt="2"/>
                                    <div className="ms-3">
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <div className="d-flex align-items-center">
                                    <img src={admin03} className="img-fluid rounded-pill  avatar-50" alt="3"/>
                                    <div className="ms-3">
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <div className="d-flex align-items-center">
                                    <img src={admin04} className="img-fluid rounded-pill  avatar-50" alt="4"/>
                                    <div className="ms-3">
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <div className="d-flex align-items-center">
                                    <img src={admin05} className="img-fluid rounded-pill  avatar-50" alt="5"/>
                                    <div className="ms-3">
                                        <h6 className="heading-title fw-bolder mb-2">Sausage Pizza</h6>
                                        <p className="mb-0">20.01.2021</p>
                                    </div>
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                <div className="d-flex align-items-center">
                                    <img src={admin06} className="img-fluid rounded-pill avatar-50" alt="6"/>
                                    <div className="ms-3">
                    ...
                    <div className="card" data-iq-gsap="onStart"
                        ...
                        <Card.Body>
                            ...
                            data-iq-ease="none">
                                        <div className="card-body">
                                            <img src={lay6} className="avatar-45 img-fluid mb-3" alt="img"/>
                                ...
                                <Col>
                                    <div className="card bg-soft-primary mb-0 menu-card-2 mb-lg-0" data-iq-gsap="onStart"
                            data-iq-opacity="0"
                            data-iq-position-y="-40"
                            data-iq-duration=".6"
                            data-iq-delay="1"
                            ...
                            data-iq-ease="none">
                                        <Card.Body>
                                            <img src={lay7} className="avatar-45 img-fluid mb-3" alt="img"/>
                                ...
                                <Col>
                                    <div className="card col bg-soft-primary mb-0 menu-card-3 mb-lg-0" data-iq-gsap="onStart"
                            data-iq-opacity="0"
                            data-iq-position-y="-40"
                            data-iq-duration=".6"
                            data-iq-delay="1"
                            ...
                            data-iq-ease="none">
                                        <Card.Body>
                                            <img src={lay39} className="avatar-45 img-fluid mb-3" alt="img"/>
                    ...
                    <div data-iq-gsap="onStart"
                        ...
                        <Card.Body>
                            <div className="d-flex align-items-center mb-5">
                                <div className="me-3">
                                    <img src={admin07} className="img-fluid rounded-pill  avatar-50" alt=""/>
                                </div>
                                <div className="flex-grow-1">
                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                        <h6 className="heading-title fw-bolder">Veg Cripsy</h6>
                                        <h6 className="heading-title">67%</h6>
                                    </div>
                                    <Progress softcolors="primary" color="primary" className="shadow-none w-100" value={67} minvalue={0} maxvalue={100} style={{height: "6px"}} />
                                </div>
                            </div> 
                            <div className="d-flex align-items-center mb-5">
                                <div className="me-3">
                                    <img src={admin08} className="img-fluid rounded-pill  avatar-50" alt=""/>
                                </div>
                                <div className="flex-grow-1">
                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                        <h6 className="heading-title fw-bolder">Paneer Chilly</h6>
                                        <h6 className="heading-title">40%</h6>
                                    </div>
                                    <Progress softcolors="primary" color="primary" className="shadow-none w-100" value={40} minvalue={0} maxvalue={100} style={{height: "6px"}} />
                                </div>
                            </div> 
                            <div className="d-flex align-items-center mb-5">
                                <div className="me-3">
                                    <img src={admin09} className="img-fluid rounded-pill  avatar-50" alt=""/>
                                </div>
                                <div className="flex-grow-1">
                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                        <h6 className="heading-title fw-bolder">Creamy Nachos</h6>
                                        <h6 className="heading-title">90%</h6>
                                    </div>
                                    <Progress softcolors="primary" color="primary" className="shadow-none w-100" value={90} minvalue={0} maxvalue={100} style={{height: "6px"}} />
                                </div>
                            </div> 
                            <div className="d-flex align-items-center mb-5">
                                <div className="me-3">
                                    <img src={admin10} className="img-fluid rounded-pill  avatar-50" alt=""/>
                                </div>
                                <div className="flex-grow-1">
                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                        <h6 className="heading-title fw-bolder">Veg kholapuri</h6>
                                        <h6 className="heading-title">50%</h6>
                                    </div>
                                    <Progress softcolors="primary" color="primary" className="shadow-none w-100" value={50} minvalue={0} maxvalue={100} style={{height: "6px"}} />
                                </div>
                            </div> 
                            <div className="d-flex align-items-center mb-5">
                                <div className="me-3">
                                    <img src={admin11} className="img-fluid rounded-pill  avatar-50" alt=""/>
                                </div>
                                <div className="flex-grow-1">
                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                        <h6 className="heading-title fw-bolder">Hot and Sour soup</h6>
                                        <h6 className="heading-title">37%</h6>
                                    </div>
                                    <Progress softcolors="primary" color="primary" className="shadow-none w-100" value={37} minvalue={0} maxvalue={100} style={{height: "6px"}} />
                                </div>
                            </div> 
                            <div className="d-flex align-items-center">
                                <div className="me-3">
                                    <img src={admin12} className="img-fluid rounded-pill  avatar-50" alt=""/>
                                </div>
                                <div className="flex-grow-1">
                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                        <h6 className="heading-title fw-bolder">Hot and Sour soup</h6>
